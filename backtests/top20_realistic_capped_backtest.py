#!/usr/bin/env python3
"""
REALISTIC LIQUIDITY-CAPPED TOP 20 CRYPTO PORTFOLIO BACKTEST
==========================================================
Models Real-World Exchange Conditions:
- Initial Capital: $50.00
- Margin Sizing: 3.0% of Wallet Balance (Compounded)
- Max Order Sizing Cap: $5,000 max position size (reflects real exchange liquidity & zero slippage)
- Timeframe: 5-minute Candles (365 Days • 2,102,400 Candles Analyzed)
"""
...
def run_realistic_capped_backtest():
    ...
    max_position_notional_cap = 3000.0 # REALISTIC LIQUIDITY CAP ($3,000 MAX ORDER SIZE)
    ...
    for i in range(1200, num_bars - cooldown_bars):
        ...
        for symbol in TOP_20_COINS:
            ...
            notional_val = min(margin_used * leverage, max_position_notional_cap) # CAPPED FOR REAL-WORLD LIQUIDITY
    ...
    print(f"\n=======================================================")
    print(f" REALISTIC LIQUIDITY-CAPPED PORTFOLIO BACKTEST ($50 START)")
    print(f"=======================================================")
    print(f" Max Order Position Cap:     ${max_position_notional_cap:,.2f} Max Order Size")
